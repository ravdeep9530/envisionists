...
if (isset($_POST['addTest'])) {
    ...
    $course = $_POST['course'];
    $tmarks = $_POST['tmarks'];
    $connect->query("INSERT INTO `test`(`name`, `tui`, `date`, `total_marks`, `obt_marks`, `precentage`, `class`, `course_name`, `duration`,des,`type`) VALUES ('$tname','$ui',NOW(),$tmarks,-1,0,'$cat','$course',$dur,'$des','req')") or die($connect->error);
...
<div class="container">
    <div class="row center-block">
        <div class="col-md-4 col-xs-offset-1">
            <div class="login-panel panel panel-default" style="padding:2%;">
                ...
                <div class="panel-body">
                    <form action="" method="post" enctype="multipart/form-data" class="row m0 contact-form "
                          id="createForm">
                        <p>Select Class<br/>
                            <select name="cat" id="cat" required onchange="window.location.href='?c_id='+this.value"
                                    class="form-control">
                        ...
                        <p>Select document:<br/>
                            <input type="button" id="uu" class="form-control" onClick="show_form()"
                                   value="Upload Document"/>
                            <input type="text" id="ui" name="uip" hidden="hidden" required/>
                        </p>
                        <p>Description:
                            <textarea name="description" id="des" required name="des" placeholder="Description"
        ...
        <div class="col-md-6 col-xs-offset-1" style="height: 600px; overflow: scroll;">
            <div class="login-panel panel panel-default" style="padding:2%;">
                <div class="panel-heading"><u>Allocate Requested Test</u></div>
                <div class="panel-body">

                    <div class="col-lg-12">
                        <p>Select Class<br/>
                            <select id="ccat" required onchange="window.location.href='?cc_id='+this.value"
                                    class="form-control">
                                <option value="">--Select One--</option>
                                <option value="6th">6th</option>
                                <option value="7th">7th</option>
                        ...
                        ?>
                        <p>Select Test<br/>
                            <select name="cat" id="rt" required class="form-control">
                                <option value="">--Select One--</option>
                                <?php
                                $sxrcx = $connect->query("SELECT * FROM test WHERE  class='$cl' AND `type`='req'");
                    ...
                    <form id="req_test">
                        ...
                        if (isset($_GET['cc_id'])) {
                            ...
                            $sxrcx = $connect->query("SELECT * FROM people WHERE type='student' AND class='$cl'");
                        while ($ss = $sxrcx->fetch_assoc())
                        {
                            ...
                            <div class="alert alert-success col-lg-12"><span class="col-lg-9"><i
                                    ...
                                    class="pull-right col-lg-3"><input type="checkbox" value="<?= $ss['hex'] ?>"
                                                                       class="btn btn-sm btn-success req"/></span></div>
                        ...
                        ?>
                            <script>$('#ccat').val('<?=$cl?>');</script>
                            <?php
                        }
                        ?>
                    </form>
                    <div class="col-lg-12">
                        <button type="button" id="ab" class="btn btn-block btn-success" onclick="add_req_test()">
                            Allocate Test
                        </button>
                    </div>
                </div>
            ...
            <div class="back" onClick="show_off()" id="bb"
                 style="display:none; z-index:2000; top:0; left:0; background-color:rgba(51,51,51,0.5); position:fixed; width:100%; height:100%;"></div>
                    ...
                    <div class="col-md-4 col-xs-offset-4">
                        <div class="login-panel panel panel-default" style="padding:2%;">
                            ...
                            <form id="form" action="ajaxUploadChapter.php" method="post" enctype="multipart/form-data">
                                ...
                                <input id="button" type="submit" class=" form-control btn-block btn-success"
                                       value="Upload">
                                </br>
                            </form>
                        </div>
                ...
                function add_req_test() {
                    ...
                    for (var i = 0; i < rc.length; i++) {
                        if (rc[i].checked) {
                            ...
                            $.get('addReqTest.php?hex=' + rc[i].value + '&tid=' + $('#rt').val(), function (data) {
                    ...
                    <div class="col-md-12" >
                        ...
                        <div class="mu-latest-course-single">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <?php
                                    $sxrcx=$connect->query("SELECT * FROM test WHERE  `type`='req' ORDER BY id DESC");
                                    while($ss=$sxrcx->fetch_assoc())
                                    {
