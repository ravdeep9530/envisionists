     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-contact-area">
          ...
          <div class="mu-title">
            <h2>Get in Touch</h2>
            <p>Leave your details and make  part of our services.</p>
          </div>
          <!-- end title -->
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mu-contact-left">
                  <form class="contactform" action="update_contact.php" method="post">                  
                    <p class="comment-form-author">
                      <label for="author">Name <span class="required">*</span></label>
                      <input type="text" required size="30" value="" name="name">
                    </p>
                    ...
                    <p class="comment-form-comment">
                      ...
                      <textarea required aria-required="true" rows="8" cols="45" name="message"></textarea>
                    </p>                
                    <p class="form-submit">
